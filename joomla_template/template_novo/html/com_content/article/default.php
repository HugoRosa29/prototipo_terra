...
// Helper do template usado no final do layout (tags/metakeys)
...
?>
<div class="single-page item-page<?php echo $this->pageclass_sfx; ?>">
	<div class="page-header">
		<?php if (!$useDefList && $this->print): ?>
			<div id="pop-print" class="btn pull-right">
				<?php echo JHtml::_('icon.print_screen', $this->item, $params); ?>
			</div>
		<?php endif; ?>
		<?php if (!$this->print): ?>
			<?php if ($canEdit || $params->get('show_print_icon') || $params->get('show_email_icon')): ?>
				<ul class="list-unstyled list-inline pull-right actions">
