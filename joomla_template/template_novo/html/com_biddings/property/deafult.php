			...
			<div class="row mega-btn">
					...
					<?php if($this->item->show_imoveis_disponiveis != 0 || $this->item->show_imoveis_disponiveis == '' ) : ?>
							<div class="col-md-12 mb-4">
								<div class="btn-ver-imoveis-disponives">
									<a target="_blank" href="https://comprasonline-homol.terracap.df.gov.br/" role="button" class="btn-light-default">
						...
						<?php if($this->item->id != 237 ): ?>
								<div class="col-md-4">
									<div class="btn-ver-imoveis">
										<a target="_blank" href="https://comprasonline-homol.terracap.df.gov.br/editais/detalhar/<?php echo (int)$this->item->number; ?>/<?php echo $this->item->year; ?>" role="button" class="btn-light-default">
				...
				<div class="col-md-4">
					<div class="btn-ver-resultado">
						<a target="_blank" href="https://comprasonline-homol.terracap.df.gov.br/bidding/external/index?edict_year=<?php echo $this->item->year; ?>&edict_number=<?php echo (int)$this->item->number; ?>" class="btn-light-default">
