...
<div class="reset<?php echo $this->pageclass_sfx; ?>">
	...
	<?php endif; ?>
	<form id="user-registration" action="<?php echo JRoute::_('index.php?option=com_users&task=reset.request'); ?>" method="post" class="form-validate form-vertical" role="form">
				...
				<div class="col-md-4">
					<fieldset>
						<?php foreach ($this->form->getFieldset($fieldset->name) as $name => $field): ?>
							<?php $this->form->setFieldAttribute($field->fieldname, 'class', 'form-control'); ?>
