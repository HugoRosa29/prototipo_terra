				...
				<div class="col-md-7">
					<div class="item-date card-download-date">
						<span class="bloco-data bloco-border">
							...
							<span class="bloco-data-descricao">
								...
								<?php 
									if($this->item->date_start_prop != '0000-00-00'){
										echo JHtml::_("date", strtotime($this->item->date_start_prop), "d F"); 

									}else{
										echo JHtml::_("date", strtotime($this->item->date_start), "d F"); 
						...
						<span class="bloco-data">
							...
							<span class="bloco-data-descricao">
								...
								<?php 
									if($this->item->date_end_prop != '0000-00-00'){
										echo JHtml::_("date", strtotime($this->item->date_end_prop), "d F");
									}else{
										echo JHtml::_("date", strtotime($this->item->date_end), "d F");
									}
								 ?>
							</span>	
						</span>
					...
					<div class="btn-proposta">
						<?php if ($this->item->featured): ?>
							...
							<a href="https://servicosonline2.terracap.df.gov.br/" class="btn-light-default" target="_blank"><i class="ico-download"></i><span class="btn-light-texto"> <?php echo JText::_('COM_DIRECTSALES_PURCHASE_OFFER'); ?></span></a>
						<?php endif; ?>
					</div>
